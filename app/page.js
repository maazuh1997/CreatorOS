...
export default function Home() {
  ...
  async function signOut() {
    await fetch('/api/auth', { method: 'DELETE' }); setUser(null); setResult(null); setUsage(null); setShowBrand(false); setShowAdmin(false)
  }
  ...
  function openPlatform(name, item) {
    if (item?.caption) copy(`${item.caption}\n\n${(item.hashtags || result?.hashtags || []).join(' ')}`)
