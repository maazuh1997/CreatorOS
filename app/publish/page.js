...
const platforms = {
  Instagram: { label: 'Instagram', icon: '◎', action: 'Open Instagram' },
  Facebook: { label: 'Facebook', icon: 'f', action: 'Open Facebook' },
  LinkedIn: { label: 'LinkedIn', icon: 'in', action: 'Open LinkedIn' },
  TikTok: { label: 'TikTok', icon: '♪', action: 'Open TikTok' },
  YouTube: { label: 'YouTube', icon: '▶', action: 'Open YouTube' },
  X: { label: 'X', icon: '𝕏', action: 'Open X' }
}
...
export default function PublishPage() {
  ...
  useEffect(() => {
    try {
      const stored = sessionStorage.getItem('creatoros_publish')
